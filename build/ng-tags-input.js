 ...
 * License: MIT
 *
 * Generated at 2014-05-26 19:42:02 +0200
 */
(function() {
'use strict';
...
tagsInput.run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put('ngTagsInput/auto-complete-contact.html',
    "<div class=\"autocomplete\" ng-show=\"suggestionList.visible\"><ul class=\"suggestion-list\"><li class=\"suggestion-item\" ng-repeat=\"item in suggestionList.items track by track(item)\" ng-class=\"{selected: item == suggestionList.selected}\" ng-click=\"addSuggestion()\" ng-mouseenter=\"suggestionList.select($index)\"><div class=\"contact-picture\" back-img=\"{{item.picture}}\" color-gen=\"{{item._id}}\"></div><div class=\"contact-informations\"><div class=\"name\" ng-bind-html=\"highlightContactName(item.completeName)\"></div><div class=\"mail\" ng-bind-html=\"highlight(item)\"></div></div></li></ul></div>"
  );
}]);
